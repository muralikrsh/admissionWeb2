...
"&ipaddr="+ipaddr;
		...
		function updatepage(str){
			...
			if(arr[0].trim()=="0000".trim()) {
					displayAlert("Result : " + "Your Application has been submitted.",'goHome');
			} else {
...
<body onload="disableCourse()">
	...
	<tr>
		<td>Parent Name & Relationship</td>
	...
	<tr>
		<td>Date of Birth</td>
		<td align=left nowrap>
		<input type="text" name="dob" value="<%=dob %>" id="dob" class="required" STYLE="width:210px" readonly/>
		</td>
	</tr>
