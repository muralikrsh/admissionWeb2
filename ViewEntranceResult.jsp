...
try {
	...
	strAnswerNo=request.getParameter("AnswerNo");
	...
	if(strAnswerNo!=null)
	{
		...
		CounsellingLetter cl=new CounsellingLetter();
		cl.generatePDF(strAnswerNo);
		System.out.println("strAnswerNo="+strAnswerNo+" "+cl);
	}
...
<title>Results</title>
    ...
    <script src="Scripts/CustomScript.js" type="text/javascript"></script>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function getCounsellingLeter() {
				location.href='CounselLetterPDF.jsp?AnswerNo='+document.getElementById("AnswerNo").value;
			}			
...
<img height="110" width="110" src="images/bharath32.png" alt="31 Years" title="" /></div>
	...
	<td><input type="text" name="AppnNo" value="<%=strAppnNo%>"  id="AppnNo"/>
	<input type="hidden" name="AnswerNo" value="<%=strAnswerNo%>"  id="AnswerNo"/></td>
	<tr>
	</td>
	</tr>
	...
	<tr>
	 <td colspan=4 align="right">
	 <input type="button" class="clickButton" value="Download Counselling Letter" onClick="javascript:getCounsellingLeter()"/>&nbsp;
	 </td>
	 </tr>
	<%
	} else {
