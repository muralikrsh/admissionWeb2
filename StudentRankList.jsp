    ...
    <script src="Scripts/CustomScript.js" type="text/javascript"></script>
		...
		<script type="text/javascript" charset="utf-8">
			...
			%>
				...
				aDataSet[<%=i%>][7]='<a href=\'StudentDetails.jsp?flag=U&ans_no=<%=alSub.get(7)%>\'>Update</a>';
			...
			function getSMSData() {
				location.href='StudentRankList.jsp?HallTicNo='+document.getElementById("HallTicNo").value+'&MobileNo='+document.getElementById("MobileNo").value+'&AppnNo='+document.getElementById("AppnNo").value+'&flag=Y';
			}
...
<%@include file="MBHandler.jsp" %>
	...
	<tr><td colspan=4>
		<tr><td colspan=4 class="button navy gradient">Student Details</td></tr>
