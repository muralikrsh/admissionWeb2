...
try
{
	String strAllotmentNo=request.getParameter("AllotNo");
        	...
        	pst=con.prepareStatement("SELECT stu_name, par_name, course, branch, tution_fee, mobile, email, pay_type_1, cash_ref_no_1, dd_no_1, amount_1 FROM student_admission where full_adm_no=?");
        	pst.setString(1,strAllotmentNo);
        	rs=pst.executeQuery();        	
        	
        	Document docPDF = new Document(PageSize.A4);
			//PdfWriter pdf = PdfWriter.getInstance(docPDF, new FileOutputStream("C:\\Allotment_Letter\\"+strAllotmentNo+".pdf"));
            ...
            String strTitle="COUNSELLING LETTER FOR ALLOCATING SEAT AND BRANCH";
