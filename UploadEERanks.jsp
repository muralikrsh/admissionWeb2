...
<body>
	...
	<form action="UploadEERanksResult.jsp" method="post" enctype="multipart/form-data" name="form1" id="form1">
	<table class=" valign_top textbox_medium tbl_p5 textarea_normal" width="90%">
		<tr><td colspan=2>&nbsp;</td></tr>
		<tr><td  colspan=2 class="button navy gradient">Upload Exam Results</td></tr>
		<tr><td colspan=2>&nbsp;</td></tr>
		<tr>
			<td class='label'>Exam Name</td>
			<td>
			<select name="exam_id" id='exam_id'  class='required' STYLE="width: 250px">
