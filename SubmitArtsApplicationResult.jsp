...
if(appfee_flag.intern()=="O".intern()) {
	...
	String str="BHARTUNIV|"+txnNo+"|NA|500.00|NA|NA|NA|INR|NA|R|bhartuniv|NA|NA|F|"+appn_no+"|APPLN|"+first_name+"|NA|NA|NA|NA|http://bharathuniverp.com/admissionWeb2/PaymentStatus.jsp";
