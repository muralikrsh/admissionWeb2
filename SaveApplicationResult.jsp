...
if(appfee_flag.intern()=="O".intern()) 
{
	...
	String str="BHARTUNIV|"+txnNo+"|NA|900.00|NA|NA|NA|INR|NA|R|bhartuniv|NA|NA|F|"+appn_no+"|APPLN|"+first_name+"|NA|NA|NA|NA|http://admission.bharathuniv.ac.in/admissionWeb2/PaymentStatus.jsp";
