...
var validateform=$("#formPersonal").validate({
    ...
    invalidHandler: function(form, validator) {
		...
		function loadCourseList() {
			var fullTime=[ "M.Tech", "M.Sc", "MBA", "MCA" ];
			var partTime=[ "M.Tech", "M.Sc", "MBA" ];
      ...
      /* function loadtestcentre(obj){
		...
		function loadCourseData(obj) {
			...
			if(sel_course.trim()=="B.Arch" || sel_course.trim()=="MCA" || sel_course.trim()=="MBA" || sel_course.trim()=="BBA" || sel_course.trim()=="BCA") {
			...
			else if(sel_course.trim()=="BA") {
				document.getElementById("choice_2").disabled=true;
				document.getElementById("choice_3").disabled=true;
				loadCourses(sel_course,course_type);
			}
			
			else if(sel_course.trim()=="M.Sc") {
				document.getElementById("choice_3").disabled=true;
				loadCourses(sel_course,course_type);
			}
...
//alert("save 3");
   ...
   //,fillSpace:true
     ...
     console = {};
			...
			$('#admission_date').datepicker().val("<%=admission_date%>").trigger('change');
...
<body >
	...
	<tr>
		<td>Admission No</td>
		<td><input type="text" id="admission_no" name="admission_no" size='15'   maxlength=5 class="number" value="<%=admission_no%>"/></td>
	</tr>
	<tr>
		<td>Admission Date<font color="red">*</font></td>
		<td align=left nowrap>
		<input size=30 type="text" class="admission_date" name="admission_date" value=""  readonly="readonly" value='<%=admission_date%>'  id="dob"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td align=left nowrap>
		<select id="religion" name="religion" class="required" STYLE="width: 210px">
			<option value="">Select Nationality</option>
...
<!--	Commented by Alexpandiyan 24.3.15
<tr>
		<td>Examination preferred</td>
		<td>
