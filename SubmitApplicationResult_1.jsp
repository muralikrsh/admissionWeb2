...
if(oth_marks_1.intern()=="-".intern())  oth_marks_1="0";
...
if(oth_marks_2.intern()=="-".intern())  oth_marks_2="0";
...
if(oth_marks_3.intern()=="-".intern())  oth_marks_3="0";
...
if(appfee_flag.intern()=="O".intern()) {
	...
	String str="BHARTUNIV|"+txnNo+"|NA|2.00|NA|NA|NA|INR|NA|R|bhartuniv|NA|NA|NA|"+appn_no+"|APP|"+name+"|NA|NA|NA|NA|http://bharathuniverp.com/admission/PaymentStatus.jsp";
