...
<!DOCTYPE html>
<html>
<title>Generate Intimation Letters</title>
	<head>
	<meta charset="utf-8">
 ...
 function generateIL() {
	if($("#frmupload").valid()) {
	 var url="GenerateIntimationLetterResult.jsp?exam_id="+encodeURIComponent(document.frmupload.exam_id.value);
	 postRequest(url);
	}
 }
...
<body>
	...
	<div class="content_container">
		<form name="frmupload" id="frmupload">
			...
			<tr><td colspan=2 class="button navy gradient">Generate Intimation Letter</td></tr>
			 <tr><td colspan=2>&nbsp;</td></tr>
			 <tr>
			...
			<select  class="required" name="exam_id" id='exam_id' STYLE="width: 250px">
			 ...
			 <input type="button" class="clickButton" value="Generate Intimation Letters" onClick="JavaScript:generateIL()"/>
			 </td>
			  </tr>
